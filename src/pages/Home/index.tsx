...
import { Card, Spinner, CategoryList } from "@/components";
...
function Home() {
  ...
  return (
    <div className="App">
      <section className="container max-w-md py-8 mx-auto px-4">
